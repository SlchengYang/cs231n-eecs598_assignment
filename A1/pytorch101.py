...
def mutate_tensor(
    ...
    for index in range(len(indices)):
        x[indices[index][0]][indices[index][1]] = values[index]
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    return x
...
def slice_assignment_practice(x: Tensor) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    x[0:4,0:6] = torch.tensor([[0,1,2,2,2,2],[0,1,2,2,2,2],
...
def reshape_practice(x: Tensor) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    y = x.reshape(2,3,4).contiguous().transpose(0,1).contiguous()
    y = y.view(3, -1)
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
...
def normalize_columns(x: Tensor) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    cul_mean = torch.mean(x,dim=0)
    y = x-cul_mean
    std = torch.zeros(x.shape[1])
    for i in range(x.shape[1]):
        s = 0
        for j in range(x.shape[0]):
            s += (x[j, i]-cul_mean[i])**2
        std[i] = sqrt(s/(x.shape[0]-1))
    y = y/std
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
